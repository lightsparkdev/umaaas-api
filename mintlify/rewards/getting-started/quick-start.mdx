...
5. **Execute a quote** to complete the Bitcoin purchase and transfer a reward to the Spark wallet
...
## Step 5: Create and Execute a Quote

Create an execute a trade from USD to BTC, and initiate the final transfer in one step.
...
6. ✅ Executed a quote to purchase Bitcoin and send to the Spark wallet
