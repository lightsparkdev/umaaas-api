...
```bash
curl -X GET 'https://api.umaaas.com/internal-account?customerId=Customer:019542f5-b3e7-1d02-0000-000000000001' \
...
```bash
curl -X POST 'https://api.umaaas.com/customers/external-accounts' \
  -H 'Authorization: Basic <base64-encoded-credentials>' \
...
```bash
curl -X GET 'https://api.umaaas.com/receiver/external-account/ExternalAccount:a12dcbd6-dced-4ec4-b756-3c3a9ea3d123?customerId=Customer:019542f5-b3e7-1d02-0000-000000000001' \
  -H 'Authorization: Basic <base64-encoded-credentials>'
```
...
```bash
curl -X POST 'https://api.umaaas.com/quotes' \
  -H 'Authorization: Basic <base64-encoded-credentials>' \
  -H 'Content-Type: application/json' \
  -d '{
    "lookupId": "LookupRequest:019542f5-b3e7-1d02-0000-000000000009",
...
```bash
curl -X POST 'https://api.umaaas.com/quotes/Quote:019542f5-b3e7-1d02-0000-000000000006/execute' \
  -H 'Authorization: Basic <base64-encoded-credentials>'
```
