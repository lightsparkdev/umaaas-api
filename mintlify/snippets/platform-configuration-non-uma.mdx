...
<Note>
For payouts payments, you do not need UMA-specific fields like `umaProviderRequiredCustomerFields` or `umaProviderRequiredCounterpartyCustomerFields`. The configuration is simpler and focuses on basic currency requirements.
</Note>
