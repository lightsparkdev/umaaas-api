---
title: "Core Concepts"
description: "Understanding the key entities in the Grid API"
---

This page provides a high-level overview of the key entities in the Grid API and their relationships to each other.
...
A visual diagram showing how platforms, customers, internal accounts, external accounts, and UMA addresses are connected will be displayed here.
</Info>
