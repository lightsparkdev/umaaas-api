<Info>
Use the `/config` endpoint to view and update your platform configuration for pay-to-bank payments.
...
## Configuration Parameters for Pay-to-Bank
...
### Supported Currencies for Pay-to-Bank
