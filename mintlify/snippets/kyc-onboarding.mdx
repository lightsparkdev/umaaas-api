...
<Tip>
If your platform is configured incorrectly, please reach out to Lightspark support, and we'll get that resolved.
</Tip>
...
- ✅ **Use Direct API Onboarding** or **Hosted KYC Link Flow** for customers
- ✅ Provide essential fields required by UMA providers
