...
description: "Configuring users in UMA Connect"
---
...
- UMA address (e.g., `$john.doe@mycompany.com`). If you don't assign an UMA address when creating a user, they will be assigned a system-generated one.
...
The Grid API will validate these requirements and will throw an error if they are not met.
...
1. **Identity Verification**: Implement proper KYC/KYB identity verification before creating users in the Grid API system
