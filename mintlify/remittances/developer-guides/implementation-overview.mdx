...
- If implementing UMA, set your UMA domain and brand details used for UMA addressing
    - Configure required counterparty and compliance fields for your target corridors

## Onboarding customers
Onboard customers and assign UMA addresses if implementing UMA. There are two patterns:
...
You'll also need to persist the Grid customer IDs and UMA handles for use in payment flows
...
- Resolve the counterparty: look up receiver information (bank account, UMA, Spark address) for compliance review and to determine capabilities
