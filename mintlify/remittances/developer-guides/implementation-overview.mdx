...
1. [Set up your platform configuration](/uma-connect/developer-guides/platform-configuration)
2. [Configure your users](/uma-connect/developer-guides/configuring-users)
3. [Send payments](/uma-connect/developer-guides/sending-payments)
4. [Receive payments](/uma-connect/developer-guides/receiving-payments)
5. [Handle webhooks](/uma-connect/developer-guides/webhooks)
