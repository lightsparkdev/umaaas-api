...
out the [Quickstart Guide KYC/KYB section](/pay-to-bank/quickstart#choosing-your-onboarding-flow) for more information.
...
```http
GET /users?platformUserId={platformUserId}&userType={userType}&createdAfter={createdAfter}&createdBefore={createdBefore}&cursor={cursor}&limit={limit}
```
...
1. **Identity Verification**: Choose a proper KYC/KYB identity verification flow as detailed in the [Quickstart Guide](/pay-to-bank/quickstart#choosing-your-onboarding-flow)
