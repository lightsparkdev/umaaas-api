...
<Tip>
  ...
  Accounts](/pay-to-bank/depositing-funds/internal-accounts) and [External
  Accounts](/pay-to-bank/depositing-funds/external-accounts) guides first.
</Tip>
...
<Tip>
  See the [Webhooks guide](/pay-to-bank/developer-guides/webhooks) for complete
...
<CardGroup cols={2}>
<Card title="Receive Payments" icon="arrow-down-to-bracket" href="/pay-to-bank/payment-flow/receive-payment">
...
<Card
  ...
  icon="list"
  href="/pay-to-bank/payment-flow/list-transactions"
>
  Query and filter transaction history
</Card>

<Card title="Reconciliation" icon="file-invoice-dollar" href="/pay-to-bank/payment-flow/reconciliation">
