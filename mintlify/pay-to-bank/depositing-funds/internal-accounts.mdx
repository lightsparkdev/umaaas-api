...
1. **Deposit funds**: You or your customers deposit money into internal accounts using bank transfers (ACH, wire, PIX, etc.)
...
When customers need to deposit funds, display the funding payment instructions in your application:
...
<CardGroup cols={2}>
<Card title="External accounts" icon="building-columns" href="/pay-to-bank/depositing-funds/external-accounts">
...
<Card title="Cross-currency transfers" icon="earth-americas" href="/pay-to-bank/getting-started/cross-currency-transfers">
