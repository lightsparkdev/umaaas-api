---
title: "Cross-Border Payments Guide"
...
- **Webhook Security**: Implement [webhook verification](/uma-connect/developer-guides/webhooks)
- **Sandbox Testing**: Test your integration in [sandbox mode](/uma-connect/developer-guides/sandbox-testing)

## Related Resources

- [Platform Configuration](api-reference/platform-configuration/get-platform-configuration) - Configure your platform
- [Webhooks Guide](/uma-connect/developer-guides/webhooks) - Real-time notifications
- [Sandbox Testing](/uma-connect/developer-guides/sandbox-testing) - Safe testing environment