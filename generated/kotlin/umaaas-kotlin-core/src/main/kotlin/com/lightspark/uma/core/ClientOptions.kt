...
package com.lightspark.uma.core

import com.fasterxml.jackson.databind.json.JsonMapper
import com.lightspark.uma.core.http.Headers
import com.lightspark.uma.core.http.HttpClient
import com.lightspark.uma.core.http.PhantomReachableClosingHttpClient
import com.lightspark.uma.core.http.QueryParams
import com.lightspark.uma.core.http.RetryingHttpClient
...
private constructor(
    ...
    companion object {
        ...
        const val PRODUCTION_URL = "https://api.uma.money/umaaas/rc"
    ...
    class Builder internal constructor() {
        ...
        fun fromEnv() = apply {
            System.getenv("UMAAAS_BASE_URL")?.let { baseUrl(it) }
            System.getenv("CLIENT_ID")?.let { username(it) }
            System.getenv("CLIENT_SECRET")?.let { password(it) }
            System.getenv("WEBHOOK_PUBLIC_KEY")?.let { webhookSignature(it) }
        }
        ...
        fun build(): ClientOptions {
            ...
            webhookSignature.let {
                if (!it.isEmpty()) {
                    headers.put("X-UMAaas-Signature", it)
                }
            }
