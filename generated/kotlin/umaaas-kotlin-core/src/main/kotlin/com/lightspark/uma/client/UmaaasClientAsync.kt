...
/**
 * A client for interacting with the Umaaas REST API asynchronously. You can also switch to
...
interface UmaaasClientAsync {
    ...
    /** A view of [UmaaasClientAsync] that provides access to raw HTTP responses for each method. */
