...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BulkUploadResponse].
         *
    ...
    /** A builder for [BulkUploadResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(bulkUploadResponse: BulkUploadResponse) = apply {
            jobId = bulkUploadResponse.jobId
            status = bulkUploadResponse.status
            additionalProperties = bulkUploadResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BulkUploadResponse].
         *
    ...
    fun validate(): BulkUploadResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BulkUploadResponse && jobId == other.jobId && status == other.status && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "BulkUploadResponse{jobId=$jobId, status=$status, additionalProperties=$additionalProperties}"
}
