...
import com.lightspark.uma.client.UmaaasClientImpl
...
class UmaaasOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [UmaaasOkHttpClient]. */
        fun builder() = Builder()

        fun fromEnv(): UmaaasClient = builder().fromEnv().build()
    }

    /** A builder for [UmaaasOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [UmaaasClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): UmaaasClient =
            UmaaasClientImpl(
                clientOptions
                    .httpClient(
