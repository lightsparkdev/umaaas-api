...
import com.lightspark.uma.core.http.HttpRequestBody
import com.lightspark.uma.core.http.HttpResponse
import com.lightspark.uma.errors.UmaaasIoException
...
private constructor(private val okHttpClient: okhttp3.OkHttpClient, private val baseUrl: HttpUrl) :
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        return try {
            ...
            throw UmaaasIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
    ...
    private fun newCall(request: HttpRequest, requestOptions: RequestOptions): Call {
        ...
        val logLevel =
            when (System.getenv("UMAAAS_LOG")?.lowercase()) {
        ...
        if (logLevel != null) {
            clientBuilder.addNetworkInterceptor(
                HttpLoggingInterceptor().setLevel(logLevel).apply {
                    ...
                    redactHeader("X-UMAaas-Signature")
                }
            )
        }
