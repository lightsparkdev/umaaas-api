...
package com.lightspark.uma.client.okhttp

import com.fasterxml.jackson.databind.json.JsonMapper
import com.lightspark.uma.client.UmaaasClientAsync
import com.lightspark.uma.client.UmaaasClientAsyncImpl
import com.lightspark.uma.core.ClientOptions
import com.lightspark.uma.core.Timeout
...
class UmaaasOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [UmaaasOkHttpClientAsync]. */
        fun builder() = Builder()

        fun fromEnv(): UmaaasClientAsync = builder().fromEnv().build()
    }

    /** A builder for [UmaaasOkHttpClientAsync]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [UmaaasClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): UmaaasClientAsync =
            UmaaasClientAsyncImpl(
                clientOptions
                    .httpClient(
