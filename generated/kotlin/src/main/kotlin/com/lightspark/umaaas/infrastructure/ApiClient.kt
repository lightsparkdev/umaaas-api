package com.lightspark.umaaas.infrastructure

import com.lightspark.umaaas.auth.HttpBasicAuth
import com.lightspark.umaaas.auth.ApiKeyAuth
...
class ApiClient(
    ...
    constructor(
        ...
        authNames.forEach { authName ->
            val auth: Interceptor? = when (authName) { 
                ...
                "WebhookSignature" -> ApiKeyAuth("header", "X-UMAaas-Signature")
    ...
    companion object {
        @JvmStatic
        protected val baseUrlKey: String = "com.lightspark.umaaas.baseUrl"

        @JvmStatic
        val defaultBasePath: String by lazy {
            System.getProperties().getProperty(baseUrlKey, "https://api.uma.money/umaaas/2025-05-15")
        }
    }
}
