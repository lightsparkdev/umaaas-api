...
# **lookup_uma**
> LookupUma200Response lookup_uma(receiver_uma_address, sender_uma_address=sender_uma_address, user_id=user_id)
...
with umaaas_api.ApiClient(configuration) as api_client:
    ...
    sender_uma_address = 'sender_uma_address_example' # str | UMA address of the sender (optional if userId is provided) (optional)
    user_id = 'user_id_example' # str | System ID of the sender (optional if senderUmaAddress is provided) (optional)

    try:
        # Look up a UMA address for payment
        api_response = api_instance.lookup_uma(receiver_uma_address, sender_uma_address=sender_uma_address, user_id=user_id)
