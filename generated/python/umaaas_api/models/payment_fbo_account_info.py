...
class PaymentFboAccountInfo(PaymentBankAccountInfo):
    """
    PaymentFboAccountInfo
    """ # noqa: E501
    payment_url: StrictStr = Field(description="The url to make request to in order to confirm payment", alias="paymentUrl")
    payment_method: StrictStr = Field(description="The HTTP method to use for confirming the payment", alias="paymentMethod")
    __properties: ClassVar[List[str]] = ["accountType", "paymentUrl", "paymentMethod"]
