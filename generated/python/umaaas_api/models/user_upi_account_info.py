...
class UserUpiAccountInfo(UserBankAccountInfo):
    """
    UserUpiAccountInfo
    """ # noqa: E501
    vpa: StrictStr = Field(description="Virtual Payment Address for UPI payments")
    account_holder_name: Optional[StrictStr] = Field(default=None, description="Name of the account holder", alias="accountHolderName")
    __properties: ClassVar[List[str]] = ["accountType", "platformAccountId", "vpa", "accountHolderName"]
