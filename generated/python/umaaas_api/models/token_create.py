...
class TokenCreate(BaseModel):
    ...
    TokenCreate
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the token to help identify it")
    permissions: List[Permission] = Field(description="A list of permissions to grant to the token")
