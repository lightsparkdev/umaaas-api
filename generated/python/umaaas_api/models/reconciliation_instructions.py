...
class ReconciliationInstructions(BaseModel):
    """
    ReconciliationInstructions
    """ # noqa: E501
    reference: StrictStr = Field(description="Unique reference code that must be included with the payment to match it with the correct incoming transaction")
