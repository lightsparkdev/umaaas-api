...
class PaymentUsAccountInfo(PaymentBankAccountInfo):
    """
    ...
    __properties: ClassVar[List[str]] = ["accountType", "accountNumber", "routingNumber", "accountCategory", "bankName", "accountHolderName"]
