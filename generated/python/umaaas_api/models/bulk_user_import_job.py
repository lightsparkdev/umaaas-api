...
class BulkUserImportJob(BaseModel):
    """
    BulkUserImportJob
    """ # noqa: E501
    ...
    progress: BulkUserImportJobProgress
    errors: Optional[List[BulkUserImportJobErrorsInner]] = Field(default=None, description="Detailed error information for failed entries")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "progress": BulkUserImportJobProgress.from_dict(obj["progress"]) if obj.get("progress") is not None else None,
            "errors": [BulkUserImportJobErrorsInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None,
