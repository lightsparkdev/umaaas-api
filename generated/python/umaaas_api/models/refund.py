...
class Refund(BaseModel):
    ...
    Refund
    """ # noqa: E501
    reference: StrictStr = Field(description="The unique reference code of the refund")
    initiated_at: datetime = Field(description="When the refund was initiated", alias="initiatedAt")
    settled_at: Optional[datetime] = Field(default=None, description="When the refund was or will be settled", alias="settledAt")
    __properties: ClassVar[List[str]] = ["reference", "initiatedAt", "settledAt"]
