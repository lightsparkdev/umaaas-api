...
class UploadUsersCsv202ResponseValidationSummaryErrorsInner(BaseModel):
    """
    UploadUsersCsv202ResponseValidationSummaryErrorsInner
    """ # noqa: E501
    row: Optional[StrictInt] = Field(default=None, description="Row number in the CSV file (1-based)")
    errors: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["row", "errors"]
