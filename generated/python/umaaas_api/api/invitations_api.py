...
class InvitationsApi:
    ...
    def cancel_invitation(
        self,
        invitation_code: Annotated[StrictStr, Field(description="The code of the invitation to cancel")],
        ...
        :param invitation_code: The code of the invitation to cancel (required)
    ...
    def _cancel_invitation_serialize(
        ...
        if invitation_code is not None:
            _path_params['invitationCode'] = invitation_code
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/invitations/{invitationCode}/cancel',
    ...
    def claim_invitation(
        self,
        invitation_code: Annotated[StrictStr, Field(description="The code of the invitation to claim")],
        claim_invitation_request: ClaimInvitationRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param invitation_code: The code of the invitation to claim (required)
        :type invitation_code: str
        :param claim_invitation_request: (required)
        :type claim_invitation_request: ClaimInvitationRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._claim_invitation_serialize(
            invitation_code=invitation_code,
            claim_invitation_request=claim_invitation_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def claim_invitation_with_http_info(
        self,
        invitation_code: Annotated[StrictStr, Field(description="The code of the invitation to claim")],
        claim_invitation_request: ClaimInvitationRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def claim_invitation_without_preload_content(
        self,
        invitation_code: Annotated[StrictStr, Field(description="The code of the invitation to claim")],
        claim_invitation_request: ClaimInvitationRequest,
        _request_timeout: Union[
    ...
    def _claim_invitation_serialize(
        self,
        invitation_code,
        claim_invitation_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if claim_invitation_request is not None:
            _body_params = claim_invitation_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/invitations/{invitationCode}/claim',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_invitation(
        self,
        invitation_code: Annotated[StrictStr, Field(description="The code of the invitation to get")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param invitation_code: The code of the invitation to get (required)
        :type invitation_code: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def _get_invitation_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/invitations/{invitationCode}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
