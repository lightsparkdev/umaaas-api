...
class PlatformConfigurationApi:
    ...
    def update_platform_config(
        self,
        update_platform_config_request: UpdatePlatformConfigRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param update_platform_config_request: (required)
        :type update_platform_config_request: UpdatePlatformConfigRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_platform_config_serialize(
            update_platform_config_request=update_platform_config_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_platform_config_with_http_info(
        self,
        update_platform_config_request: UpdatePlatformConfigRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def update_platform_config_without_preload_content(
        self,
        update_platform_config_request: UpdatePlatformConfigRequest,
        _request_timeout: Union[
            None,
    ...
    def _update_platform_config_serialize(
        self,
        ...
        # process the form parameters
        # process the body parameter
        if update_platform_config_request is not None:
            _body_params = update_platform_config_request
