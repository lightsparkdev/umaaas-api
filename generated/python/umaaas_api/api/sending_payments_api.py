...
class SendingPaymentsApi:
    ...
    def get_payment_status(
        self,
        quote_id: Annotated[StrictStr, Field(description="ID of the quote to check payment status for")],
        reference: Annotated[Optional[StrictStr], Field(description="Payment reference code (optional, but helps with verification)")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param quote_id: ID of the quote to check payment status for (required)
        :type quote_id: str
        :param reference: Payment reference code (optional, but helps with verification)
        :type reference: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_payment_status_serialize(
            quote_id=quote_id,
            reference=reference,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetPaymentStatus200Response",
            '401': "Error",
            '404': "Error",
        }
        response_data = self.api_client.call_api(
    ...
    @validate_call
    def get_payment_status_with_http_info(
        self,
        quote_id: Annotated[StrictStr, Field(description="ID of the quote to check payment status for")],
        reference: Annotated[Optional[StrictStr], Field(description="Payment reference code (optional, but helps with verification)")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetPaymentStatus200Response]:
        """Check payment status for a quote
    ...
    @validate_call
    def get_payment_status_without_preload_content(
        self,
        quote_id: Annotated[StrictStr, Field(description="ID of the quote to check payment status for")],
        reference: Annotated[Optional[StrictStr], Field(description="Payment reference code (optional, but helps with verification)")] = None,
        _request_timeout: Union[
    ...
    def _get_payment_status_serialize(
        self,
        quote_id,
        reference,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/payments/status/{quoteId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
