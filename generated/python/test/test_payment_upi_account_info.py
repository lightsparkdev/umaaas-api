...
class TestPaymentUpiAccountInfo(unittest.TestCase):
    """PaymentUpiAccountInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentUpiAccountInfo:
        """Test PaymentUpiAccountInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentUpiAccountInfo`
        """
        model = PaymentUpiAccountInfo()
        if include_optional:
            return PaymentUpiAccountInfo(
                vpa = 'someuser@okbank',
    ...
    def testPaymentUpiAccountInfo(self):
        """Test PaymentUpiAccountInfo"""
