...
class TestTransactionFailureReason(unittest.TestCase):
    """TransactionFailureReason unit test stubs"""
    ...
    def testTransactionFailureReason(self):
        """Test TransactionFailureReason"""
        # inst = TransactionFailureReason()
