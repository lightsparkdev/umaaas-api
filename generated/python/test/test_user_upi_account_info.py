...
class TestUserUpiAccountInfo(unittest.TestCase):
    """UserUpiAccountInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserUpiAccountInfo:
        """Test UserUpiAccountInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserUpiAccountInfo`
        """
        model = UserUpiAccountInfo()
        if include_optional:
            return UserUpiAccountInfo(
                vpa = 'someuser@okbank',
    ...
    def testUserUpiAccountInfo(self):
        """Test UserUpiAccountInfo"""
