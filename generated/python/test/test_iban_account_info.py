...
class TestIbanAccountInfo(unittest.TestCase):
    """IbanAccountInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IbanAccountInfo:
        """Test IbanAccountInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IbanAccountInfo`
        """
        model = IbanAccountInfo()
        if include_optional:
