...
class TestUserBankAccountInfo(unittest.TestCase):
    """UserBankAccountInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserBankAccountInfo:
        """Test UserBankAccountInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserBankAccountInfo`
        """
        model = UserBankAccountInfo()
        if include_optional:
    ...
    def testUserBankAccountInfo(self):
        """Test UserBankAccountInfo"""
