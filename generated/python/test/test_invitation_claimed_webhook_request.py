...
class TestInvitationClaimedWebhookRequest(unittest.TestCase):
    """InvitationClaimedWebhookRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvitationClaimedWebhookRequest:
        """Test InvitationClaimedWebhookRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvitationClaimedWebhookRequest`
        """
        model = InvitationClaimedWebhookRequest()
        if include_optional:
            return InvitationClaimedWebhookRequest(
    ...
    def testInvitationClaimedWebhookRequest(self):
        """Test InvitationClaimedWebhookRequest"""
