...
class TestIndividualUpdate(unittest.TestCase):
    """IndividualUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IndividualUpdate:
        """Test IndividualUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IndividualUpdate`
        """
        model = IndividualUpdate()
        if include_optional:
