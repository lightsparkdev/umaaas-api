...
class TestOutgoingRateDetails(unittest.TestCase):
    """OutgoingRateDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OutgoingRateDetails:
        """Test OutgoingRateDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OutgoingRateDetails`
        """
        model = OutgoingRateDetails()
        if include_optional:
            return OutgoingRateDetails(
    ...
    def testOutgoingRateDetails(self):
        """Test OutgoingRateDetails"""
