...
class TestUpiAccountInfo(unittest.TestCase):
    """UpiAccountInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpiAccountInfo:
        """Test UpiAccountInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpiAccountInfo`
        """
        model = UpiAccountInfo()
        if include_optional:
            return UpiAccountInfo(
                vpa = 'someuser@okbank',
