...
class ListUsers200Response(BaseModel):
    ...
    """ # noqa: E501
    data: List[ListUsers200ResponseDataInner] = Field(description="List of users matching the filter criteria")
    has_more: StrictBool = Field(description="Indicates if more results are available beyond this page", alias="hasMore")
    ...
    total_count: Optional[StrictInt] = Field(default=None, description="Total number of users matching the criteria (excluding pagination)", alias="totalCount")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [ListUsers200ResponseDataInner.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
