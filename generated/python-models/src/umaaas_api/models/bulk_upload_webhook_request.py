...
class BulkUploadWebhookRequest(BaseModel):
    ...
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('SUCCESS', 'PARTIAL_SUCCESS', 'FAILED'):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "progress": BulkUploadWebhookRequestProgress.from_dict(obj.get("progress")) if obj.get("progress") is not None else None,
            "errors": [BulkUploadWebhookRequestErrorsInner.from_dict(_item) for _item in obj.get("errors")] if obj.get("errors") is not None else None
        })
        return _obj
