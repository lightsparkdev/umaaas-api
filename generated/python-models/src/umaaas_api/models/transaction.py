...
class Transaction(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["transactionId", "status", "type", "senderUmaAddress", "receiverUmaAddress", "userId", "platformUserId", "settlementTime", "createdAt", "description", "counterpartyInformation"]
