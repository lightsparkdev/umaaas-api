...
class LookupUma200Response(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.required_payer_data_fields:
            for _item in self.required_payer_data_fields:
                if _item:
                    _items.append(_item.to_dict())
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "supportedCurrencies": [CurrencyPreference.from_dict(_item) for _item in obj.get("supportedCurrencies")] if obj.get("supportedCurrencies") is not None else None,
            "requiredPayerDataFields": [CounterpartyFieldDefinition.from_dict(_item) for _item in obj.get("requiredPayerDataFields")] if obj.get("requiredPayerDataFields") is not None else None
        })
        return _obj
