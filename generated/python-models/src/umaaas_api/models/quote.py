...
class Quote(BaseModel):
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in ('PENDING', 'PROCESSING', 'COMPLETED', 'FAILED', 'EXPIRED'):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "sendingCurrency": Currency.from_dict(obj.get("sendingCurrency")) if obj.get("sendingCurrency") is not None else None,
            "receivingCurrency": Currency.from_dict(obj.get("receivingCurrency")) if obj.get("receivingCurrency") is not None else None,
            ...
            "paymentInstructions": PaymentInstructions.from_dict(obj.get("paymentInstructions")) if obj.get("paymentInstructions") is not None else None,
