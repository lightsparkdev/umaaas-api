...
class GetBulkUserImportJob200Response(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "progress": GetBulkUserImportJob200ResponseProgress.from_dict(obj.get("progress")) if obj.get("progress") is not None else None,
            "errors": [GetBulkUserImportJob200ResponseErrorsInner.from_dict(_item) for _item in obj.get("errors")] if obj.get("errors") is not None else None,
