...
class CurrencyPreference(BaseModel):
    ...
    """ # noqa: E501
    currency: Currency
    estimated_exchange_rate: Union[StrictFloat, StrictInt] = Field(description="An estimated exchange rate from the sender's currency to this currency. This is not a locked rate and is subject to change when calling the quotes endpoint.", alias="estimatedExchangeRate")
    ...
    __properties: ClassVar[List[str]] = ["currency", "estimatedExchangeRate", "min", "max"]
