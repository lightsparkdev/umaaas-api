...
class ListTransactions200Response(BaseModel):
    ...
    """ # noqa: E501
    data: List[GetTransactionById200Response] = Field(description="List of transactions matching the criteria")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [GetTransactionById200Response.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
