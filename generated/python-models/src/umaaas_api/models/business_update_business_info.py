...
class BusinessUpdateBusinessInfo(BaseModel):
    """
    BusinessUpdateBusinessInfo
    """ # noqa: E501
    legal_name: Optional[StrictStr] = Field(default=None, description="Legal name of the business", alias="legalName")
    registration_number: Optional[StrictStr] = Field(default=None, description="Business registration number", alias="registrationNumber")
    tax_id: Optional[StrictStr] = Field(default=None, description="Tax identification number", alias="taxId")
    __properties: ClassVar[List[str]] = ["legalName", "registrationNumber", "taxId"]
