...
class ListTokens200Response(BaseModel):
    """
    ListTokens200Response
    """ # noqa: E501
    data: List[ApiToken] = Field(description="List of tokens matching the filter criteria")
    ...
    total_count: Optional[StrictInt] = Field(default=None, description="Total number of tokens matching the criteria (excluding pagination)", alias="totalCount")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [ApiToken.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
