...
from umaaas_api.models.extra_models import TokenModel
...
def get_token_WebhookSignature(
    token_api_key_header: str = Security(
        APIKeyHeader(name="X-UMAaas-Signature", auto_error=False)
    ),
) -> TokenModel:
    """
    Check and retrieve authentication information from api_key.

    :param token_api_key_header API key provided by Authorization[X-UMAaas-Signature] header
